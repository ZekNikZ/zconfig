...
public abstract class BasicPropertySpecBuilder<T> extends PropertySpecBuilder<T, T> {
    ...
    @Override
    public BasicPropertySpec<T> build() {
    ...
    public static class String extends BasicPropertySpecBuilder<java.lang.String> {
        protected String(java.lang.String key) {
            super(key, BasicPropertySpec::String);
        }
    ...
    public static class Integer extends BasicPropertySpecBuilder<java.lang.Integer> {
        protected Integer(java.lang.String key) {
            super(key, BasicPropertySpec::Integer);
        }
    ...
    public static class Double extends BasicPropertySpecBuilder<java.lang.Double> {
        protected Double(java.lang.String key) {
            super(key, BasicPropertySpec::Double);
        }
    ...
    public static class Boolean extends BasicPropertySpecBuilder<java.lang.Boolean> {
        protected Boolean(java.lang.String key) {
            super(key, BasicPropertySpec::Boolean);
        }
    }
}
